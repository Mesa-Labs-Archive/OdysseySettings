...
public class Common {
    ...
    public static final int DEF_VAL_FAB_POS = 2; //RIGHT
    ...
    public static final int INT_ID_THEME_PURPLE = 0;
    public static final int INT_ID_THEME_BLUE = 1;
    public static final int INT_ID_THEME_RED = 2;
    public static final int INT_ID_THEME_YELLOW = 3;
    public static final int INT_ID_THEME_ORANGE = 4;
    public static final int INT_ID_THEME_GREEN = 5;
